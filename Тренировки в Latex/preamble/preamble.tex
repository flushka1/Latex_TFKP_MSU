...
\newtheorem{formula}{Формула}[section]
...
\newcommand{\CourseName}{Теория функций комплексной переменной}
\newcommand{\FullCourseNameFirstPart}{\so{ТЕОРИЯ ФУНКЦИЙ КОМПЛЕКСНОЙ ПЕРЕМЕННОЙ}}
\newcommand{\SemesterNumber}{III}
\newcommand{\LecturerInitials}{Иван Иванович Иванов}
\newcommand{\CourseDate}{лето 2023}
\newcommand{\AuthorInitials}{Керик}
\newcommand{\VKLink}{https://vk.com/kokerel}
\newcommand{\GithubLink}{https://github.com/flushka1/Latex_TFKP_MSU}
...
\newpagestyle{main}{
	...
	\setfootrule{0.4pt}                       
	\setfoot{ФФ МГУ, \CourseDate}{}{\thepage} 
}
\pagestyle{main}  
